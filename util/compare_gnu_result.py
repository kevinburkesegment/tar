#!/usr/bin/env python3
"""
Compare the current GNU tar test results to the last results gathered from the
main branch to highlight if a PR is making the results better or worse.
"""
